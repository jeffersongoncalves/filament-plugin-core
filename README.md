...
![Filament Plugin Core](https://raw.githubusercontent.com/jeffersongoncalves/filament-plugin-core/2.x/art/jeffersongoncalves-filament-plugin-core.png)
...
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/jeffersongoncalves/filament-plugin-core/fix-php-code-style-issues.yml?branch=2.x&label=code%20style&style=flat-square)](https://github.com/jeffersongoncalves/filament-plugin-core/actions?query=workflow%3A"Fix+PHP+code+styling"+branch%3A2.x)
...
```bash
composer require jeffersongoncalves/filament-plugin-core:"^2.0"
```
